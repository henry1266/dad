...
#####開檔1號
firefox 投影片參考樣板資料夾現在要用/投影片秀易經古文解析講座$course.html	##先放易經古文分卦全文投影片
...
#####開檔2號
firefox 投影片參考樣板資料夾現在要用/投影片秀易經古文解析講座卦駁段$course.html	##再放分段卦駁文投影片
	cp -a 投影片參考樣板資料夾現在要用 易經總戰果1資料夾	#怕放完就不見了,所以另存暫存戰果資料夾	
	rm -rf 投影片參考樣板資料夾現在要用
	cp -a 投影片參考樣板資料夾 投影片參考樣板資料夾現在要用	#復歸原始 
...
#####開檔3號
#firefox 投影片參考樣板資料夾現在要用/投影片秀易經古文解析講座彖象段$course.html	#放分段彖象投影片
	cp -a 投影片參考樣板資料夾現在要用 易經總戰果1資料夾	#怕放完就不見了,所以另存暫存戰果資料夾	
	rm -rf 投影片參考樣板資料夾現在要用
	cp -a 投影片參考樣板資料夾 投影片參考樣板資料夾現在要用	#復歸原始  
